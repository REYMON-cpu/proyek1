                            ...
                            <form action="{{ route('review.store') }}" method="POST">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="review_content" rows="4" required placeholder="Gopet keren banget..." class="w-full bg-[#F8FBF0] border-0 rounded-3xl py-4 px-6 focus:ring-2 focus:ring-[#D9B08C] transition-all outline-none"></textarea>
                                    </div>
                        ...
                        <div class="bg-white p-8 rounded-[35px] shadow-sm border border-gray-50 flex gap-6">
                            ...
                            <div>
                                <div class="flex justify-between items-start mb-4">
                                    <div>
                                        <h4 class="font-bold text-[#2D433E]">Aurellia Ledy</h4>
                                        <p class="text-xs text-gray-400">Chiro (Anjing)</p>
                                    </div>
                                    <div class="flex text-yellow-400 text-xs gap-1">
                                        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                    </div>
                                </div>
                                <p class="text-gray-600 text-sm italic">"Sangat terbantu! Pet sitternya ramah banget dan sering kasih update foto Chiro pas aku lagi sibuk ngampus di ULBI."</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-10">
            <div class="bg-[#2D433E] rounded-[60px] p-10 lg:p-20 overflow-hidden relative">
                ...
                <div class="flex flex-col lg:flex-row gap-20 relative z-10">
                    ...
                    <div class="lg:w-2/3 bg-white/5 backdrop-blur-md rounded-[40px] p-8 lg:p-12 border border-white/10">
                        <form action="#" class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    <label class="text-xs font-bold text-white/50 uppercase ml-4">Nama Lengkap</label>
                                    <input type="text" placeholder="Nama Lengkap" class="w-full bg-white/10 border-0 rounded-2xl py-4 px-6 text-white placeholder:text-white/20 focus:ring-2 focus:ring-[#D9B08C] transition-all">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-xs font-bold text-white/50 uppercase ml-4">Email</label>
                                    <input type="email" placeholder="Contoh@gmail.com" class="w-full bg-white/10 border-0 rounded-2xl py-4 px-6 text-white placeholder:text-white/20 focus:ring-2 focus:ring-[#D9B08C] transition-all">
                                </div>
                            </div>
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-white/50 uppercase ml-4">Pesan</label>
                                <textarea rows="4" placeholder="Halo Gopet, saya mau tanya..." class="w-full bg-white/10 border-0 rounded-3xl py-4 px-6 text-white placeholder:text-white/20 focus:ring-2 focus:ring-[#D9B08C] transition-all"></textarea>
                            </div>
                            <button class="w-full py-5 bg-[#D9B08C] text-[#2D433E] font-black rounded-2xl hover:bg-white transition-all transform hover:scale-[1.02]">
